...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private final String VALID_EMAIL = "@iastate.edu";
    /**
    ...
    private void attemptLogin() {
        ...
        {
            mPasswordView.setError(getString(R.string.error_invalid_password_repeat_chars));
            focusView = mPasswordView;
            cancel = true;
        }
    ...
    private boolean passwordRepeat(String password){
